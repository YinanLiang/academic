...
<div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--12-col">
    ...
    <form action="<?php echo base_url("index.php/pec/submitForm");?>" method="post" class="mdl-grid">
        <div class="mdl-card__supporting-text mdl-cell--6-col" >
            <!-- fields -->
        ...
        <div class="mdl-card__supporting-text mdl-cell--6-col" >
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo mdl-cell mdl-cell--12-col">
                <input class="mdl-textfield__input datepicker" type="text" name="date_pec"/>
        ...
        <div class="mdl-card__supporting-text mdl-cell--6-col">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo mdl-cell mdl-cell--12-col">
                <input class="mdl-textfield__input #date_pec" type="text" name="date_payment"/>
        ...
        <div class="mdl-card__supporting-text mdl-cell--6-col">
            ...
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label textfield-demo mdl-cell mdl-cell--12-col">
                <input class="mdl-textfield__input datepicker" type="text" name="date_fec"/>
                <label class="mdl-textfield__label">Date</label>
            </div>
        </div>
        <div class="mdl-card__actions mdl-card--border">
            <!-- buttons -->
            <button type="submit" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent">
                Save
            </button>
